...
public final class CodeEvaluationPrompts {
    ...
    private static final String REVIEW_SYSTEM_MANIM =
            "You are a senior Manim code reviewer.\n"
                    ...
                    + "- Reserve blocking clutter findings for clearly unreadable code-level evidence such as persistent full-strength crowding, overlapping cards, or missing beat separation around a major reveal.\n"
