...
public final class PromptTemplates {
    ...
    public static final String VISUAL_DESIGN_SYSTEM =
            ...
            + "- \"layout\": describe the relative projected arrangement on the 16:9 frame,"
            + " including which elements are above, below, left, right, centered, adjacent, or"
            + " reserved to a corner, but do not give absolute coordinates or numeric placements.\n"
    ...
    public static final String NARRATIVE_SYSTEM =
            ...
            + "- uses the whole ordered graph as a global layout planning pass when assigning"
            + " concrete positions\n"
            + "\n"
            ...
            + "- This stage is responsible for the final absolute coordinates and exact placements"
            + " in `layout_goal` and `entering_objects.placement`.\n"
            + "- The visual-design stage provides relative layout intent only; convert that intent"
            + " into globally consistent coordinates here.\n"
