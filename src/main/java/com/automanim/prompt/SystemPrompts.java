...
public final class SystemPrompts {
    ...
    public static final String STORYBOARD_CODEGEN_INTRO_GEOGEBRA =
            "Use the following compact storyboard JSON as the source of truth for GeoGebra construction order, object identity, continuity, and teaching progression.\n"
                    ...
                    + "- Treat storyboard object ids as the naming source for generated GeoGebra variables. Preserve those ids in code, and when you must introduce a helper name, use the same ASCII camelCase-or-math-style rule with no underscores.\n"
